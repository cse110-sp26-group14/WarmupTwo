...
To document our verification evidence in one place, we included a supporting file named `test_document.pdf` in the `final-report` directory. This document contains our validation/testing proof artifacts (including checker and test evidence) used to support the engineering quality claims in this report.
