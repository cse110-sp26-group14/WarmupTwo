...
const THEME_LIBRARY = Object.freeze({
  ...
  oasis: {
    ...
    symbols: [
      ...
      { key: 'DUNE', label: 'Dune', icon: '???' },
      { key: 'LAMP', label: 'Lamp', icon: '??' },
      { key: 'STAR', label: 'Star', icon: '?' },
      { key: 'OASIS', label: 'Spring', icon: '??' },
      { key: 'FALCON', label: 'Falcon', icon: '??' },
